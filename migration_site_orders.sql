...
-- Orders placed from a published builder site's product/service detail page.
CREATE TABLE IF NOT EXISTS `site_orders` (
  ...
  CONSTRAINT `fk_site_orders_site` FOREIGN KEY (`site_id`) REFERENCES `sites` (`id`) ON DELETE CASCADE
...
CREATE TABLE IF NOT EXISTS `site_reviews` (
  ...
  CONSTRAINT `fk_site_reviews_site` FOREIGN KEY (`site_id`) REFERENCES `sites` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
