...
<div class="card-wrap">
  ...
  <?php endif; ?>
  <div style="text-align:center;font-size:0.7rem;padding:0 16px 14px;opacity:0.35;color:#c4b5fd;">An innovative Product From : <strong>Mr Print World Pvt Ltd.</strong></div>
