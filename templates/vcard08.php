...
$qrUrl = 'https://api.qrserver.com/v1/create-qr-code/?size=150x150&data='.urlencode($cardUrl . '?s=qr');
...
<div class="card-wrap">
  ...
  <div class="about-block fade-in-section"><p><?= renderDescription($vcard['description']) ?></p></div>
  <?php endif; ?>
