<?php
/**
 * TAPIFY - WhatsApp Store Template 10 — "Prime Store" (v2, e-commerce listing)
...
<div class="main-content mx-auto w-100 overflow-hidden d-flex flex-column justify-content-between">
  <div>
    ...
    <div class="banner-section position-relative mb-30"><div class="banner-img"><img src="<?= $bannerImg ?>" class="w-100 h-100 object-fit-cover" alt="banner"></div></div>
