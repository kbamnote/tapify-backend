<?php
/**
 * TAPIFY - WhatsApp Store Template 15 — "The Royal Jewellers" (v2, light theme)
 * Converted from webStoreTemps/Theme 7. Renders shared $store/$categories/$products.
 */
$cfg   = $templateConfig ?? [];
$asset = '/webStore_templates/assets/store_template_15';
$defC  = $cfg['default_colors'] ?? ['primary' => '#b8860b', 'secondary' => '#1a1408', 'accent' => '#e6c463'];
...
body{background:#fdfbf7;color:#1a1408;font-family:'Poppins',sans-serif;overflow-x:hidden;}
.d-none{display:none!important;}
:root{--tp:<?= $P ?>;--ts:<?= $S ?>;--ta:<?= $A ?>;}

.tp-bg-vector{position:fixed;pointer-events:none;z-index:0;opacity:.06;}
...
.tp-nav-brand{display:flex;align-items:center;gap:10px;text-decoration:none;color:#1a1408;}
...
.tp-nav-brand span{font-size:17px;font-weight:600;color:#1a1408;}
...
.tp-cart-btn{position:relative;background:none;border:none;cursor:pointer;color:#1a1408;font-size:22px;}
...
.tp-section-title{font-size:22px;font-weight:700;color:#1a1408;margin:28px 0 16px;padding:0 24px;position:relative;z-index:1;}
...
.tp-cat-circle{width:72px;height:72px;border-radius:50%;overflow:hidden;border:3px solid transparent;margin:0 auto 8px;background:#f5f0e8;}
...
.tp-carousel-arrow{position:absolute;top:50%;transform:translateY(-50%);width:32px;height:32px;border-radius:50%;background:#fff;border:1px solid #e8e0d4;cursor:pointer;display:flex;align-items:center;justify-content:center;font-size:14px;color:#333;z-index:5;box-shadow:0 2px 6px rgba(0,0,0,.06);}
...
.tp-product-card{background:#fff;border-radius:12px;overflow:hidden;display:flex;flex-direction:column;border:1px solid #f0ebe3;transition:transform .3s,box-shadow .3s;}
.tp-product-card:hover{transform:translateY(-3px);box-shadow:0 6px 20px rgba(184,134,11,.12);}
.tp-product-img{width:100%;aspect-ratio:1;overflow:hidden;background:#fdfbf7;}
...
.tp-product-name{font-size:14px;font-weight:600;color:#1a1408;margin-bottom:2px;}
.tp-product-cat{font-size:12px;color:#999;margin-bottom:8px;}
.tp-product-price{font-size:15px;font-weight:700;color:#1a1408;margin-bottom:10px;}
...
.tp-view-more{display:inline-flex;align-items:center;gap:0;background:#fff;border:1px solid #e8e0d4;border-radius:50px;overflow:hidden;text-decoration:none;transition:transform .2s,box-shadow .2s;}
.tp-view-more:hover{transform:scale(1.03);box-shadow:0 4px 12px rgba(184,134,11,.15);}
...
.tp-filter-sidebar{width:260px;min-width:260px;background:#fff;border-radius:12px;padding:20px;height:fit-content;position:sticky;top:80px;border:1px solid #f0ebe3;}
.tp-filter-sidebar input[type="search"],.tp-filter-sidebar input[type="number"],.tp-filter-sidebar select{width:100%;padding:10px 12px;border:1px solid #e8e0d4;border-radius:8px;background:#fff;color:#333;font-size:14px;outline:none;}
...
.tp-filter-section h4{font-size:15px;font-weight:700;color:#1a1408;margin-bottom:12px;padding-bottom:8px;border-bottom:1px solid #f0ebe3;}
...
.tp-cart-head{display:flex;align-items:center;justify-content:space-between;padding:18px 20px;border-bottom:1px solid #f0ebe3;color:#1a1408;}
...
.tp-ci{display:flex;gap:12px;padding:12px 0;border-bottom:1px solid #f4f4f4;color:#1a1408;}
...
.tp-cart-foot{padding:16px 20px;border-top:1px solid #f0ebe3;color:#1a1408;}
...
.tp-toast{position:fixed;top:20px;left:50%;transform:translateX(-50%) translateY(-90px);background:#1a1408;color:#fff;padding:11px 22px;border-radius:50px;font-weight:600;z-index:9999;transition:transform .35s;}
...
<div class="main-content mx-auto w-100">
  ...
  <footer style="background:#1a1408;text-align:center;padding:24px 20px;color:#ccc;font-size:14px;position:relative;z-index:1;">
