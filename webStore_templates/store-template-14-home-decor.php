<?php
/**
 * TAPIFY - WhatsApp Store Template 14 — "Home Decor" (v2, light theme)
 * Converted from webStoreTemps/Theme 6. Renders shared $store/$categories/$products.
 */
$cfg   = $templateConfig ?? [];
$asset = '/webStore_templates/assets/store_template_14';
$defC  = $cfg['default_colors'] ?? ['primary' => '#19496a', 'secondary' => '#19496a', 'accent' => '#d0a98f'];
...
.tp-product-card:hover{transform:translateY(-3px);box-shadow:0 6px 20px rgba(25,73,106,.1);}
...
<div class="main-content mx-auto w-100">
  ...
  <footer style="background:#19496a;text-align:center;padding:24px 20px;color:#ccc;font-size:14px;">
